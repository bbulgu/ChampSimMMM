...
# TODO: for traces in [add some traces here]

# TODO: for num_cpus in [1, 4, 16, 64]

# cache size calculation: Number of sets × Number of ways × Block size
# sets: 64, ways: 8
# cache sizes we want: 4, 16, 64, 256, 1024 KBs 

# TODO: for block_size in [8, 32, 128, 512, 2048]

# TODO: for mshr_l1d_size in [1, 4, 16, 64, 256]

# fiddle with broadcast latency as well 
...
for block_size in [8, 32, 128, 512, 2048]:
    for num_cpus in [1, 4, 16, 64]:
         for mshr_l1d_size in [1, 4, 16, 64, 256]:
            ...
            os.system(f"bin/champsim --warmup_instructions 0 --simulation_instructions {simulation_instructions} {traces_str} >> results/{trace_name_short}_{simulation_instructions}_{num_cpus}cpus_{block_size}block_{mshr_l1d_size}mshr.txt")
